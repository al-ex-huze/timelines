const { filterDeletedEvent } = require("../utils.js");

describe("filterDeletedEvent", () => {
    test("takes an array and returns an array", () => {
        const layoutInput = [];
        const idInput = "49";
        const actual = filterDeletedEvent(layoutInput, idInput);
    ...
    test("returns new array", () => {
        const layoutInput = [{ i: "Timeline", x: 0, y: 0, w: 8, h: 1 },
            { i: "Add Event", x: 0, y: null, w: 8, h: 1 },
            {
                i: "Event Card - 3",
                data: '{"id":"49","title":"regergre","body":"ergergre","image_url_1":"https://images.pexels.com/photos/97050/pexels-photo-97050.jpeg?w=700&h=700"}',
